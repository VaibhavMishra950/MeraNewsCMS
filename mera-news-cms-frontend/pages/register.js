...
const Login = () => {
    ...
    return (
        <div className='py-10 bg-white dark:bg-gray-950 min-h-screen'>
            <Image src={ANC_Full} width={100} height={100} alt='Mera News CMS' className='mx-auto' />
            <h2 className="mt-6 text-center text-3xl tracking-tight text-black dark:text-white">Create your account</h2>
                ...
                <div className="mb-5">
                    ...
                    <div className='flex rounded-lg overflow-hidden outline-none'>
                        <select
                            ...
                            className='bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white border border-gray-300 dark:border-gray-600 focus:border-blue-500 rounded-s-lg'
                        >
                        ...
                        <input
                            ...
                            id="mobile"
                            maxLength={10}
                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 rounded-r-lg"
                            required
                        />
                    </div>
                </div>
