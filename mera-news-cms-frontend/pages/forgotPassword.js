...
const ForgotPassword = () => {
    ...
    return (
        <div>
            ...
            <h2 className="mt-6 text-center text-3xl tracking-tight text-white">Forgot your password?</h2>
            ...
            <form className="max-w-sm mx-auto my-10">
                <div className="mb-5">
                    ...
                    <input value={email} onChange={(e) => { setEmail(e.target.value) }} disabled={isEmailDisabled} type="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="user@example.com" required />
                </div>
                {status == "verifyOTP" && <div>
                    <div className="mb-5">
                        ...
                        <input value={OTP} onChange={(e) => { setOTP(e.target.value) }} type="text" maxLength={6} id="OTP" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="000000" required />
                    </div>
                    <div className="mb-5">
                        <label htmlFor="newPass" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Enter new password</label>
                        <input value={newPass} onChange={(e) => { setNewPass(e.target.value) }} type="password" id="newPass" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                    </div>
                </div>}
                <button
                    onClick={status == "verifyOTP" ? handleSubmitOTP : handleSendOTP}
                    type="submit"
                    className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-800 dark:disabled:bg-blue-500 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
