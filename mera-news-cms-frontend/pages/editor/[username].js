...
const NewsByUser = () => {
  ...
  return (<>
    {usernameValidity && <div className='bg-gray-100 dark:bg-gray-950/80 min-h-[calc(100vh-76px)]'>
      <div className='py-5 px-14'>
        ...
        <p className='text-center text-4xl font-serif text-black dark:text-white'>News articles by @{curUsername}</p>
      </div>
