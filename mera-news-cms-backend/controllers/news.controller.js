...
const getNewsListAdmin = async (req, res) => {
    let token = req.body.token;
    try {
...
const getAllNewsListViewer = async (req, res) => {
    try {
        let data = await News.findAll({
            where: {
                live: true
...
const getOneNewsUser = async (req, res) => {
...
const getCategoryNewsListUser = async (req, res) => {
...
const getEditorNewsListUser = async (req, res) => {
