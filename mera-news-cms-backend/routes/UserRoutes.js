...
module.exports = function (app) {
    ...
    app.post('/promoteUserToEditor', async (req, res) => {
        try {
            let token = req.body.token;
    ...
    app.post('/demoteEditorToUser', async (req, res) => {
        try {
            let token = req.body.token;
    ...
    app.post('/getEditors', async (req, res) => {
        try {
            let token = req.body.token;
    ...
    app.post('/getViewers', async (req, res) => {
        try {
            let token = req.body.token;
            const { roleId } = jwt.verify(token, process.env.JWT_SECRET);
            if (roleId == 0) {
    ...
    app.post('/getUserAccountDetails', async (req, res) => {
        let token = req.body.token;
        try {
    ...
    app.post('/changeProfilePicture', uploadProfileImage.single('userProfilePic'), async (req, res) => {
        let token = req.body.token;
