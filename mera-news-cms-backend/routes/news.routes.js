...
newsRouter.route('/publishNews').post(uploadCoverImage.single('newsCoverImg'), async (req, res) => {
...
newsRouter.route('/getNewsListAdmin').post(async (req, res) => {
    let token = req.body.token;
    try {
...
newsRouter.route('/isSlugAvailable').get(async (req, res) => {
...
newsRouter.route('/updateNews').post(async (req, res) => {
    let token = req.body.token;
...
newsRouter.route('/getAllNewsListViewer').get(async (req, res) => {
    try {
        let data = await News.findAll({
            where: {
                live: true
...
newsRouter.route('/getOneNewsUser').post(async (req, res) => {
...
newsRouter.route('/getCategoryNewsListUser').post(async (req, res) => {
...
newsRouter.route('/getEditorNewsListUser').post(async (req, res) => {
...
newsRouter.route('/deleteNews').post(async (req, res) => {
    let token = req.body.token;
